...
USE_PAN_TILT = True
# 云台舵机配置（PCA9685 通道号）
PAN_STEERING_CHANNEL = 2      # 水平旋转舵机的 PCA9685 通道（默认 2）
TILT_STEERING_CHANNEL = 3     # 垂直旋转舵机的 PCA9685 通道（默认 3）

# 舵机 PWM 范围（需根据实际舵机校准）
PAN_LEFT_PWM = 200            # 水平左转的 PWM 值
PAN_RIGHT_PWM = 500           # 水平右转的 PWM 值
TILT_UP_PWM = 200             # 垂直向上的 PWM 值
TILT_DOWN_PWM = 500           # 垂直向下的 PWM 值
